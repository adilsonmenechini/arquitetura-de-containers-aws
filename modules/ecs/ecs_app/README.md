...
| <a name="input_common_tags"></a> [common\_tags](#input\_common\_tags) | Common tags | `map(string)` | <pre>{<br>  "created_by": "arquitetura_de_containers_aws",<br>  "day": "day4",<br>  "sandbox": "linuxtips"<br>}</pre> | no |
