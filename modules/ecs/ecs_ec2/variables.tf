variable "common_tags" {
  type        = map(string)
  description = "Common tags for resources to aid in organization and identification."
  default = {
...
variable "ssm_vpc_id" {
  type        = string
  description = "Path to the VPC ID stored in AWS Systems Manager Parameter Store."
  default     = "/linuxtips/vpc/vpc_id"
}

variable "ssm_private_subnet_list" {
  type        = list(string)
  description = "List of private subnet IDs stored in AWS Systems Manager Parameter Store."
  default = [
...
variable "ssm_public_subnet_list" {
  type        = list(string)
  description = "List of public subnet IDs stored in AWS Systems Manager Parameter Store."
  default = [
